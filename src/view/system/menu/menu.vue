        ...
        <Card>
          ...
          <tables ref="tables" editable searchable border
            ...
            <div slot="searchCondition">
              <Input placeholder="菜单名称" class="search-input mr5" v-model="searchRowData.name" style="width: auto"
                     clearable/>
              ...
              <Button v-waves @click="handleSearch" class="search-btn mr5 ml5" type="primary">

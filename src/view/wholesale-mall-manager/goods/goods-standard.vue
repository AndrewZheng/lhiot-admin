<template>
  <div class="m-role">
        ...
        <Row :gutter="8" type="flex" align="middle" class-name="mb10">
          <i-col span="12">
            <Row :gutter="8" type="flex" align="middle" class-name="mb10">
              ...
              <i-col span="16">
                {{ productStandardDetail.goodsCode }}
              </i-col>
            </Row>
          </i-col>
          <i-col span="12">
        ...
        <Row :gutter="8" type="flex" align="middle" class-name="mb10">
          <i-col span="12">
            <Row :gutter="8" type="flex" align="middle" class-name="mb10">
              ...
              <i-col span="16">
                {{ productStandardDetail.standardDesc }}
              </i-col>
            </Row>
          </i-col>
          <i-col span="12">
        ...
        <Row :gutter="8" type="flex" align="middle" class-name="mb10">
          <i-col span="12">
            <Row :gutter="8" type="flex" align="middle" class-name="mb10">
              ...
              <i-col span="16">
                {{ productStandardDetail.goodsUnit }}
              </i-col>
            </Row>
          </i-col>
          <i-col span="12">
        ...
        <Form ref="editForm" :model="productStandardDetail" :rules="ruleInline" :label-width="100">
          ...
          <Row>
            <i-col span="9" style="float:right;margin-bottom:10px;margin-right:9px">
              <Button v-waves type="info" @click="modalSort = true">
                商品详情图排序
              </Button>
            </i-col>
          </Row>
          ...
          <Row>
            <i-col span="12">
              <FormItem label="数量/重量:" prop="weight">
                <InputNumber v-model="productStandardDetail.weight" :min="0" style="width:100px;"></InputNumber>
              </FormItem>
            </i-col>
            <i-col span="12">
    ...
    <Modal v-model="modalRegion" :width="1200" :z-index="1000" title="区间价格管理">
      <Card>
        ...
        >
          <div slot="searchCondition">
            <i-col span="12">
              {{ productStandardDetail.standardGoodsName }}--区间价格设置
            </i-col>
          </div>
          <div slot="operations">
    ...
    <Modal v-model="modalEditRegion" :mask-closable="false">
          ...
          <Row>
            ...
            <i-col span="12">
              <FormItem label="商品排序:" prop="reorder">
                <InputNumber v-model="goodsPriceRegion.reorder" :min="0"></InputNumber>
              </FormItem>
            </i-col>
          </Row>
        </Form>
      ...
      <div slot="footer">
        <Button @click="modalEditRegion = false">
          关闭
        </Button>
        <Button :loading="modalEditLoading" type="primary" @click="handleSubmitRegin">
          确定
        </Button>
      </div>
    </Modal>

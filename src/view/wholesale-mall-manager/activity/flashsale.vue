<template>
  <div class="m-role">
    ...
    <Modal v-model="modalEdit" :width="isCreate?1300:600" :z-index="1000" :mask-closable="false" title="关联商品规格">
      <div class="modal-content">
        ...
        <Divider orientation="center" v-show="isCreate">配置抢购信息</Divider>
        ...
        <Row class="mt10">
          <Form ref="editForm" :model="flashsaleGoods" :rules="ruleInline" :label-width="80">
            ...
            <Row>
              <i-col span="12">
                <FormItem label="抢购价:" prop="specialPrice">
                  <InputNumber :min="0" :value="specialPriceComputed" @on-change="specialPriceChange"></InputNumber>
                </FormItem>
              </i-col>
              <i-col span="12">
            ...
            <div class="ml15 brand-red" v-show="isCreate">* 批量关联多个商品规格时，初始化配置信息都一样</div>
          </Form>
        </Row>
      </div>
      <div slot="footer">

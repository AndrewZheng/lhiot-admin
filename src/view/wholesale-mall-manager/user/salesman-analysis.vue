...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          render(h, params, vm) {
            const amount = fenToYuanDot2(
              params.row.perMonthPerformance
            );
        ...
        },
        {
          ...
          render(h, params, vm) {
            const amount = fenToYuanDot2(
              params.row.thisMonthPerformance
            );
            return <div>{amount}</div>;
          }
        },
  ...
  methods: {
    getTableData() {
      getPerformancePages(this.searchRowData).then(res => {
    ...
    handleView(params) {
      this.turnToPage({
        ...
        query: { id: params.row.salesUserId,

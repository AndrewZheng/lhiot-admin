<template>
  <div class="m-role">
    ...
    >
      ...
      <div class="modal-content">
        <Form ref="modalEdit" :model="customPlanDetail" :rules="ruleInline" :label-width="110" v-if="topShow">
        ...
        <Tabs value="name1" type="card" v-if="bottomShow">
          <TabPane label="周" name="name1" style="margin-bottom: 150px">
            <Form ref="weekForm" :model="customPlanDetail" :label-width="90" :rules="ruleInlineWeek">
              <Col span="8">
              ...
              <Col span="12">
                <FormItem label="第1天:" prop="selectWeek1">
                  ...
                  >
                    <Option @click.native="selectIndexWeek1(option)" class="pb5 pt5 pl15"
              ...
              <Col span="12">
                <FormItem label="第2天:" prop="selectWeek2">
                  ...
                  >
                    <Option @click.native="selectIndexWeek2(option)" class="pb5 pt5 pl15"
                            v-for="(option, index) in optionsShelfSpecification"
                            :value="option.id" :key="index">
                      {{option.productName}}
                    </Option>
              ...
              <FormItem label="第3天:" prop="selectWeek3">
                ...
                >
                  <Option @click.native="selectIndexWeek3(option)" class="pb5 pt5 pl15"
                          v-for="(option, index) in optionsShelfSpecification"
                          :value="option.id" :key="index">
                    {{option.productName}}
                  </Option>
              ...
              <FormItem label="第4天:" prop="selectWeek3">
                ...
                >
                  <Option @click.native="selectIndexWeek4(option)" class="pb5 pt5 pl15"
                          v-for="(option, index) in optionsShelfSpecification"
                          :value="option.id" :key="index">
                    {{option.productName}}
                  </Option>
              ...
              <FormItem label="第5天:" prop="selectWeek3">
                ...
                >
                  <Option @click.native="selectIndexWeek5(option)" class="pb5 pt5 pl15"
                          v-for="(option, index) in optionsShelfSpecification"
                          :value="option.id" :key="index">
                    {{option.productName}}
                  </Option>
              ...
              <FormItem label="第6天:" prop="selectWeek3">
                ...
                >
                  <Option @click.native="selectIndexWeek6(option)" class="pb5 pt5 pl15"
                          v-for="(option, index) in optionsShelfSpecification"
                          :value="option.id" :key="index">
                    {{option.productName}}
                  </Option>
              ...
              <FormItem label="第7天:" prop="selectWeek3">
                ...
                >
                  <Option @click.native="selectIndexWeek7(option)" class="pb5 pt5 pl15"
                          v-for="(option, index) in optionsShelfSpecification"
                          :value="option.id" :key="index">
                    {{option.productName}}
                  </Option>
          ...
          <TabPane label="月" name="name2">
            <Form  ref="monthForm" :model="customPlanDetail" :label-width="90" :rules="ruleInlineMonth">
              <Col span="8">
              ...
              <FormItem label="第1天:" prop="selectMonth1">
                ...
                >
                  <Option @click.native="selectIndexMonth1(option)" class="pb5 pt5 pl15"
                          v-for="(option, index) in optionsShelfSpecification"
                          :value="option.id" :key="index">
                    {{option.productName}}
                  </Option>

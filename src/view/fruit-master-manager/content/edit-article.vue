      ...
      <Form ref="modalEdit" :model="articleDetail" :rules="ruleInline" :label-width="80">
        <Row>
          <FormItem label="文章标题:" prop="title">
            <Input v-model="articleDetail.title" placeholder="文章标题" style="width: 325px"></Input>
          </FormItem>
        </Row>
        <Row>
          <FormItem label="文章作者:" prop="author">
            <Input v-model="articleDetail.author" placeholder="文章标题" style="width: 325px"></Input>
          </FormItem>
        </Row>
        <Row>
        ...
        <Row>
          <FormItem label="关键词:" prop="keywords">
            <Input v-show="false" v-model="articleDetail.keywords" style="width: auto"></Input>
            <Input v-for="(item, index) in keywords" :key="index" v-model="keywords[index]" type="text" style="width: 100px" class="search-btn mr5" @on-change="keywordChange"></Input>
            <Button type="dashed" long icon="md-add" style="width: 100px" class="search-btn mr5" @click="addKeyword">加关键词</Button>
            <Button icon="md-remove" style="width: 100px" class="search-btn mr5" @click="removeKeyword">减关键词</Button>
          </FormItem>
        </Row>
        <Row>
          <FormItem label="文章主图:" prop="headImage">
            <Input v-show="false" v-model="articleDetail.headImage" style="width: auto"></Input>
            <div v-for="(item,key) in uploadListMain" :key="'modalEdit' + key" class="demo-upload-list">

<template>
  <div class="m-role">
                ...
                <div class="demo-upload-list">
                  ...
                  <div class="demo-upload-list-cover">
                    <Icon
                      ...
                      @click.native="handleUploadView(productDetail.mainImg)"
                    ></Icon>
                  </div>
                </div>
              </i-col>
        ...
        <Row class-name="mb20">
          <i-col span="24">
            <Row>
              ...
              <i-col span="21">
                <a style="color:#0072bc; text-decoration : underline" @click="goDetail">预览效果</a>----直接打开新页面，展示详情组合图片
              </i-col>
            </Row>
          </i-col>
        </Row>
    ...
    <Modal style="z-index: 1000" v-model="modalEdit">
      <p slot="header">
        <span>修改商品基础信息</span>
      </p>
      <div class="modal-content">
        <Form ref="modalEdit" :model="productDetail" :rules="ruleInline" :label-width="80">
          ...
          <Row>
            <FormItem label="商品详情:建议尺寸 (xxx*xxx):" prop="detailImg" :label-width="80">
              ...
              >
                <div slot="content">
                  <Button type="primary" style="width:auto">上传图片</Button>
                </div>
              </IViewUpload>
            </FormItem>
          </Row>
          ...
          <Form
            ref="innerModalEdit"
            :model="productDetail.productSpecification"
            :rules="ruleInline"
          >
            <Row>
              <Col span="12">
                <FormItem label="规格单位:" prop="packagingUnit" :label-width="80">
                  <Select
                    :value="productDetail.productSpecification.packagingUnit"

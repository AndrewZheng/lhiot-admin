          ...
          <Row>
            <i-col span="12">
              <FormItem label="成团人数:" prop="fullUserNum">
                <InputNumber v-model="teambuyDetail.fullUserNum" :min="0" style="width: 200px"></InputNumber>
              </FormItem>
            </i-col>
            <i-col span="12">
          ...
          <Row>
            ...
            <i-col span="12">
              <FormItem label="已售份数:" prop="saleQuantity">
                <InputNumber v-model="teambuyDetail.saleQuantity" :min="0" style="width: 200px"></InputNumber>
              </FormItem>
            </i-col>
          </Row>
          <Row>

            ...
            <Row>
              ...
              <i-col span="18">
                <Input
                  ...
                  :rows="6"
                  :value="couponDetail.activityRuel"
                  type="textarea"
                ></Input>
              </i-col>
            </Row>
      ...
      <div class="modal-content">
        ...
        >
          ...
          >
            ...
            <Row>
              <i-col span="18">
                <FormItem label="活动规则:" prop="activityRuel">
                  <Input
                    v-model="couponDetail.activityRuel"
                    :rows="6"
                    placeholder="活动规则"
                    type="textarea"
                  ></Input>
            ...
            <Row
              v-show="
                selectActivityType === 'BUY_COUPON_ACTIVITY' ||
                  selectActivityType === 'BUY_COUPON_ACTIVITY_ALL'
              "
            >
              <i-col span="6">
                <p
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          width: 210,
          key: 'handle',
          options: ['customOnSale', 'view', 'edit', 'settings']
        }
      ],
      relationColumns: [
        ...relationTempColumns,

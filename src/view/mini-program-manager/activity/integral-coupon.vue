        ...
        <Row class-name="mb20">
          <i-col span="20">
            <Row>
              ...
              <i-col span="18">{{ addRelationDetail.couponDetail }}</i-col>
            </Row>
          </i-col>
        </Row>
        <Row class-name="mb20">
          <i-col span="20">
            <Row>
              <i-col span="5">温馨提示:</i-col>
              <i-col span="18">{{ addRelationDetail.couponReminderMsg }}</i-col>
            </Row>
          </i-col>
        </Row>
        <Row class-name="mb20">
            ...
            <Row>
              ...
              <i-col span="4">
                <FormItem label="排序字段:" prop="rank">
                  <InputNumber v-model="addRelationDetail.rank" :min="0" label></InputNumber>
                </FormItem>
              </i-col>
            </Row>
            <Row>
            ...
            <Row>
              ...
              <i-col span="6">
                <FormItem label="发券总数:" prop="couponLimit">
                  <InputNumber v-model="addRelationDetail.couponLimit" :min="0" label="限购数量"></InputNumber>
                </FormItem>
              </i-col>
            </Row>
            <Row>
              <i-col span="6">
                ...
                <FormItem v-else label="券使用范围:" prop="couponScope" :label-width="100">
                  <Select
              ...
              <i-col span="6">
                ...
                <FormItem v-else label="券使用限制:" prop="useLimitType" :label-width="100">
                  <Select
      ...
      <div class="modal-content">
        ...
        >
          ...
          <Row>
            <i-col span="6">
              <FormItem label="兑换积分:" prop="points" :label-width="100">
                <InputNumber v-model="addRelationDetail.points" label="兑换积分" style="width: 135px"></InputNumber>
              </FormItem>
            </i-col>
            <i-col span="6">
              <FormItem label="促销积分:" prop="realPoints">
            ...
            <i-col span="6">
              <FormItem label="每人限兑:" prop="receiveLimit" :label-width="120">
                <InputNumber v-model="addRelationDetail.receiveLimit" :min="0" label="限兑数量"></InputNumber>
              </FormItem>
            </i-col>
            <i-col span="6">
          ...
          <Row>
            ...
            <i-col span="6">
              <FormItem label="使用限制:" prop="useLimitType" :label-width="80">

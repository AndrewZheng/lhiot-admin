          ...
          >
            ...
            <Row>
              <i-col v-if="tempModalType == 'addTemplate'" span="6">
                <FormItem v-if="handCouponTime" label="券有效期:" prop="useLimitType">
                  <Select
        ...
        >
          ...
          <Row>
            <i-col v-if="addRelationDetail.source == 'SMALL'" span="6">
              <FormItem v-if="handCouponTime" :label-width="100" label="券有效期:" prop="useLimitType">
                <Select
                  v-model="addRelationDetail.validDateType"
                  placeholder="券有效期类型"
                  disabled
              ...
              <FormItem v-else :label-width="100" label="券有效期:" prop="useLimitType">
                <Select
                  v-model="addRelationDetail.validDateType"
                  placeholder="券有效期类型"
                  style="padding-right: 5px;width: 140px"

...
export default {
  ...
  computed: {
    showBack() {
      return this.$route.params.couponBusinessType !== '' || this.$route.params.couponBusinessType != null;
    },
    minBuyFeeComputed() {
  ...
  mounted() {
    ...
    this.searchRowData.couponBusinessType = this.$route.params.couponBusinessType ? this.$route.params.couponBusinessType : 'MANUAL_SEND';
    console.log(`current couponBusinessType: ${this.searchRowData.couponBusinessType}`);
    this.getTableData();

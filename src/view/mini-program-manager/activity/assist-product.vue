<template>
  <div class="m-role">
        ...
        <Row class-name="mb20">
          <i-col span="24">
            <Row>
              ...
              <i-col span="18">
                {{ flashsaleDetail.receiveValidDays }}
              </i-col>
            </Row>
          </i-col>
        </Row>
          ...
          <Row>
            <Card>
              ...
              >
                ...
                </Row> </Form>*Tips：请先选择要关联的商品/券，然后输入关联配置信息，添加完成后可在下方表格修改.
            </Card>
          </Row>
    ...
    >
        ...
        <Row class-name="mb20">
          <i-col span="12">
            <Row>
              ...
              <i-col span="16">
                {{ activitiesCouponDetail.couponName }}
              </i-col>
            </Row>
          </i-col>
          <i-col span="12">
        ...
        >
          <i-col span="12">
            <Row>
              ...
              <i-col span="16">
                {{ activitiesCouponDetail.beginDay }}
              </i-col>
            </Row>
          </i-col>
          <i-col span="12">
        ...
        <Row class-name="mb20">
          <i-col span="20">
            <Row>
              ...
              <i-col span="18">
                {{ activitiesCouponDetail.couponRules }}
              </i-col>
            </Row>
          </i-col>
        </Row>
        ...
        <Row class-name="mb20">
          ...
          <i-col span="12">
            <Row>
              ...
              <i-col span="16">
                {{ activitiesProductDetail.baseUnit }}
              </i-col>
            </Row>
          </i-col>
        </Row>
      ...
      <div slot="footer">
        <Button type="primary" @click="handleRelevanceClose">
          关闭
        </Button>
      </div>
    </Modal>

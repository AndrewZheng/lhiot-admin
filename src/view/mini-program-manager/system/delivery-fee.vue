        ...
        <div slot="searchCondition">
          <Row>
            ...
            <InputNumber
              ...
              style="width: 100px"
              @on-change="maxOrderAmountChange"
            ></InputNumber>
            <Select
...
export default {
              ...
              h('InputNumber', {
                ...
                on: {
                  'on-change': (e) => {
                    ...
                    this.postageDetail.deliveryRules[
                      params.row.initRowIndex
                    ].additionalFee = yuanToFenNumber(e);
                  }
                }
              })
            ]);
  ...
  methods: {
    ...
    addChildren() {
      ...
      this.postageDetail = this._.cloneDeep(postageDetail);

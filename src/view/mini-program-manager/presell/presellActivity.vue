        ...
        <Row class-name="mb20">
          <i-col span="12">
            <Row>
              ...
              <i-col span="18">{{ presellDetail.id }}</i-col>
            </Row>
          </i-col>
          <i-col span="12">
            <Row>
              <i-col span="6">活动名称:</i-col>
              <i-col span="18">{{ presellDetail.activityName }}</i-col>
            </Row>
          </i-col>
        </Row>
        <Row class-name="mb20">
          <i-col span="12">
            <Row>
              ...
              <i-col span="18">{{ presellDetail.content }}</i-col>
            </Row>
          </i-col>
          <i-col span="12">
            <Row>
        ...
        <Row class-name="mb20">
          <i-col span="12">
            <Row>
              ...
              <i-col span="18">{{ presellDetail.rank }}</i-col>
            </Row>
          </i-col>
          <i-col span="12">
            <Row>
        ...
        <Row class-name="mb20">
          <i-col span="12">
            <Row>
              ...
              <i-col span="18">{{ presellDetail.standardId }}</i-col>
            </Row>
          </i-col>
          <i-col span="12" style>
        ...
        <Row class-name="mb20">
          <i-col span="12">
            <Row>
              ...
              <i-col span="18">{{ presellDetail.standardDesc }}</i-col>
            </Row>
          </i-col>
        </Row>
        <Row class-name="mb20">
        ...
        <Row class-name="mb20">
          <i-col span="12">
            <Row>
              ...
              <i-col span="18">{{ presellDetail.commissionScale + "%" }}</i-col>
            </Row>
          </i-col>
          <i-col span="12">
            <Row>
        ...
        <Row class-name="mb20">
          <i-col span="12">
            <Row>
              ...
              <i-col span="18">{{ presellDetail.invNum }}</i-col>
            </Row>
          </i-col>
          <i-col span="12">
            <Row>
              <i-col span="6">已售份数:</i-col>
              <i-col span="18">{{ presellDetail.saleQuantity }}</i-col>
            </Row>
          </i-col>
        </Row>
        <Row class-name="mb20">
          <i-col span="24">
            <Row>
              ...
              <i-col span="21">{{ showStoreName }}</i-col>
            </Row>
          </i-col>
        </Row>
      </div>

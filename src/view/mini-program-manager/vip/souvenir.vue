          ...
          >
            ...
            <Row>
              <i-col span="6">
                ...
                <FormItem v-else :label-width="92" label="券使用范围:" prop="couponScope">
                  <Select
                    v-model="addRelationDetail.couponScope"
                    placeholder="请选择"
                    style="margin-left: -5px;width: 108px"
                  >
                    <Option
              ...
              <!-- <i-col span="6" v-if="tempModalType == 'addHdTemplate'">
                <FormItem label="优惠券状态:" prop="couponStatus" :label-width="92">
                  <Select
                    ...
                    placeholder="请选择"
                    style="padding-right: 5px;width: 82px"
                  >
                    <Option
            ...
            <Row>
              <i-col span="12">
                <FormItem :label-width="92" label="券使用规则:" prop="couponRules">
                  <Input
        ...
        >
          ...
          <Row>
            ...
            >
              ...
              <i-col span="7">
                <FormItem :label-width="100" label="有效天数:" prop="endDay">
                  <InputNumber
                    :min="0"
                    v-model="addRelationDetail.endDay"
                    label="有效天数"

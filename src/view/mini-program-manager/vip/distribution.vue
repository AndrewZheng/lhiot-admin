          ...
          <i-col span="12">
            <Row>
              ...
              <i-col v-if="addRelationDetail.couponStatus === 'VALID'" span="16">
                <tag color="success">{{ "有效" | couponStatusFilter }}</tag>
              </i-col>
              <i-col v-else-if="addRelationDetail.couponStatus === 'INVALID'" span="16">
                <tag color="error">{{ "无效" | couponStatusFilter }}</tag>
              </i-col>
            </Row>
          </i-col>
        </Row>
      ...
      <div class="modal-content">
        <Row>
          ...
          >
            <!-- <Row>
              <i-col span="8">
                <FormItem
                  label="优惠券名称:"
                  prop="couponName"
                  style="padding-right: 5px;width: 222px;"
                  clearable
                  :label-width="100"
                >
                  <Input v-model="addRelationDetail.couponName" placeholder="优惠券名称"></Input>
                </FormItem>
              </i-col>
            </Row>
            <Row>
            ...
            <Row>
              <i-col span="6">
                <FormItem :label-width="100" label="　会员身份:" prop="svipLevel">
                  <Select
            ...
            <!-- <Row>
              <i-col span="6">
                <FormItem label="优惠券类型:" prop="couponType" :label-width="100">
                  <Select
                    v-model="addRelationDetail.couponType"
                    style="padding-right: 5px;width: 120px"
                    disabled="disabled"
                  >
                    <Option
            ...
            <Row>
              <i-col span="6">
                <FormItem :label-width="100" label="　礼包类型:" prop="giftType">
                  <Select
            ...
            <Row>
              ...
              >
                <i-col span="7">
                  <FormItem :label-width="103" label="发优惠券后:" prop="beginDay">
                    <InputNumber
                      :min="0"
            ...
            <Row>
              <i-col span="12">
                <FormItem :label-width="103" label="券使用规则:" prop="couponRules">
                  <Input
    ...
    <Modal v-model="modalEdit" :mask-closable="false" :width="1000" draggable>
      ...
      <div class="modal-content">
        ...
        >
          ...
          <Row>
            <i-col span="12">
              <FormItem :label-width="100" label="券使用规则:" prop="couponRules">
                <Input
                  v-model="addRelationDetail.couponRules"
                  :autosize="{minRows: 3,maxRows: 8}"
                  type="textarea"

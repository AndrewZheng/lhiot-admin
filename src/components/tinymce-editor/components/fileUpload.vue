...
<div class="upload-container">
   <Button @click=" modalUpload= true" type="primary" size="small" v-waves>
  ...
  <Modal
       ...
       <div class="modal-content">
        ...
        <Row type="flex" :gutter="8" align="middle" class-name="mb10">
            ...
            <i-col span="20">
              <Input v-model="fileObj.fileUrl">
                <Upload slot="append" ref="fileUpload"
                  :action="actionUrl"
        ...
        <Row type="flex" :gutter="8" align="middle" class-name="mb10" v-show='isVideo'>
          <i-col span="14">
            <Row type="flex" :gutter="8" align="middle" class-name="mb10">
